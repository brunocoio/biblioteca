...
$toemails[] = array(
    'email' => MAILUSER, // Your Email Address
    'name' => 'Combat Armor Defense do Brasil | Site' // Your Name
);
...
$fromemail = array(
    'email' => MAILUSER, // Company's Email Address (preferably currently used Domain Name)
    'name' => 'Contato Site | Combat Armor Defense do Brasil' // Company Name
);
